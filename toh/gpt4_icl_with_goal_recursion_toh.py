...
for i in range(26):
	if (i+1) not in icl_examples:
		...
		Here is the sequence of minimum number of moves to reach the subgoal configuration from the starting configuration:
		...
		Here is the sequence of minimum number of moves to reach the goal configuration from the subgoal configuration:
